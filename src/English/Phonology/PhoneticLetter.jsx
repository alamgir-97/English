...
const PhoneticLetter = ({ letter }) => {
    ...
    return (
      <div className="border p-4 bg-white w-[20vw] h-[20vw] rounded-xl hover:border-3 relative">
          ...
          <div className="bg-white border hover:border-2 text-center overflow-hidden">
            ...
            <p className="text-4xl text-white font-bold p-2 bg-green-600 hover:text-green-700 hover:bg-blue-300 overflow-hidden h-[8vw]">
              {name2}
            </p>
