...
const PresentIndefiniteSentenceTwo = () => {
  const [presentIndefiniteTenseS2, setPresentIndefiniteTenseS2] = useState(); 
  ...
  useEffect(() => {
    fetch("/sentences/sentences.json")
      ...
      const presentIndefiniteTenseSentence1 = presentIndefinite.filter(sentenceOne => sentenceOne.sentencePattern ==="I am free.");
       setPresentIndefiniteTenseS2(presentIndefiniteTenseSentence1)});
  }, []);
...
<div className="flex flex-wrap  bg-red-400">
        {presentIndefiniteTenseS2?.map((sentence) => (
...
export default PresentIndefiniteSentenceTwo;
