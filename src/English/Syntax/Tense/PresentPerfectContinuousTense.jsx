...
const PresentPerfectContinuousTense = () => {
  ...
  useEffect(() => {
    fetch("/sentences/sentences.json")
      .then((res) => res.json())
      .then((data) => {const presentPerfectContinuous = data.filter(sentence=> sentence.category ==="Present Perfect Continuous Tense");
       setPresentPerfectContinuousTense(presentPerfectContinuous)});
  }, []);
