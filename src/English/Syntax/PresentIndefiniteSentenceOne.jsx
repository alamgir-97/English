...
const PresentIndefiniteSentenceOne = () => {
  const [presentIndefiniteTenseS1, setPresentIndefiniteTenseS1] = useState(); 
  ...
  useEffect(() => {
    fetch("/sentences/sentences.json")
      ...
      const presentIndefiniteTenseSentence1 = presentIndefinite.filter(sentenceOne => sentenceOne.sentencePattern ==="I eat rice");
       setPresentIndefiniteTenseS1(presentIndefiniteTenseSentence1)});
  }, []);
...
<div className="flex flex-wrap  bg-red-400">
        {presentIndefiniteTenseS1?.map((sentence) => (
...
export default PresentIndefiniteSentenceOne;
