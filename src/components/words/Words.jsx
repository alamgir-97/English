...
const Words = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 py-4 bg-green-500 gap-4">
        {words?.map((word) => (
...
const Word = ({ word }) => {
  ...
  return (
    <div className="border mx-5 my-3 p-4 bg-white w-[30vw] h-[33vw] rounded-xl hover:border-3">
